          ...
          <div className="grid md:grid-cols-2 gap-16 mb-16">
            ...
            <div className="glass p-8 rounded-2xl border-white/5">
              ...
              <p className="text-white/40 text-xs leading-relaxed">
                Heohunter adalah sistem trading, bukan mesin uang instan. Risiko tetap ada dalam setiap aktivitas trading. Gunakan modal dengan bijak. Heohunter hadir untuk membantu trader agar lebih profitable and konsisten, namun pengguna bertanggung jawab penuh atas risiko masing-masing.
              </p>
            </div>
          </div>
